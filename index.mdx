...
Nimbus provides fast, probabilistic inference for Brain-Computer Interface applications in **Python** and **Julia**. The SDKs deliver sub-30ms inference latency with full uncertainty quantification through **Bayesian LDA**, **Bayesian GMM**, **Bayesian Softmax**, and **Bayesian STS** implementations.
...
| Metric | RxLDA | RxGMM | Bayesian Softmax | RxSTS |
|--------|-------|-------|--------------|-------|
