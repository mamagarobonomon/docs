...
description: "Production-ready Bayesian inference for Brain-Computer Interfaces in Python and Julia. Fast sub-30ms inference latency with Bayesian LDA, GMM, Softmax, and STS models. Full uncertainty quantification for motor imagery, P300, and SSVEP paradigms."
keywords: ["BCI", "brain-computer interface", "Bayesian inference", "EEG", "motor imagery", "P300", "SSVEP", "probabilistic AI", "RxInfer", "Nimbus BCI", "Python SDK", "Julia SDK", "Bayesian LDA", "Bayesian GMM", "uncertainty quantification", "real-time BCI"]
icon: "brain"
---

_Production-ready Bayesian BCI inference with Bayesian LDA, Bayesian GMM, Bayesian Softmax, and Bayesian STS models_

Nimbus provides fast, probabilistic inference for Brain-Computer Interface applications in **Python** and **Julia**. The SDKs deliver sub-30ms inference latency with full uncertainty quantification through **Bayesian LDA**, **Bayesian GMM**, **Bayesian Softmax/MPR**, and **Bayesian STS** implementations.

**Choose your SDK:**

<CardGroup cols={2}>
  <Card title="Python SDK (nimbus-bci)" icon="python">
    sklearn-compatible classifiers with MNE-Python integration
  </Card>
  <Card title="Julia SDK (NimbusSDK.jl)" icon="code">
...
The SDKs provide four production-ready Bayesian models:
...
<CardGroup cols={2}>
  <Card
    ...
    href="/models/rxlda"
  >
    **Bayesian Linear Discriminant Analysis** with shared covariance. Fastest (10-15ms), efficient, ideal for well-separated classes like motor imagery. Python: `NimbusLDA`, Julia: `RxLDAModel`.
  </Card>
  <Card
    title="Bayesian GMM"
    icon="brain"
  ...
  <Card
    ...
    href="/models/rxpolya"
  >
    **Bayesian Multinomial Logistic Regression** with continuous transitions. Flexible (15-25ms), ideal for complex multinomial classification tasks. Python: `NimbusSoftmax`, Julia: `RxPolyaModel`.
  </Card>
  <Card
    title="Bayesian STS"
    icon="brain"
    href="/models/rxsts"
  >
    **Bayesian Structural Time Series** with Extended Kalman Filter. Adaptive (20-30ms), designed for non-stationary data with temporal drift, online learning. Python: `NimbusSTS`.
  </Card>
</CardGroup>
...
| Metric | RxLDA | RxGMM | Bayesian MPR | RxSTS |
|--------|-------|-------|--------------|-------|
...
- **Models**: NimbusLDA, NimbusGMM, NimbusSoftmax (Polya-Gamma VI), NimbusSTS (Kalman Filter)
...
- ✅ sklearn-compatible classifiers: NimbusLDA, NimbusGMM, NimbusSoftmax, NimbusSTS
...
<script type="application/ld+json">
{
  ...
  "description": "Production-ready Bayesian inference for Brain-Computer Interfaces in Python and Julia. Fast sub-30ms inference latency with full uncertainty quantification.",
  ...
  "keywords": "BCI, brain-computer interface, Bayesian inference, EEG, motor imagery, P300, SSVEP, probabilistic AI, RxInfer, Python SDK, Julia SDK"
}
</script>
