...
_Production-ready Bayesian BCI inference with Bayesian LDA (RxLDA), Bayesian GMM (RxGMM), and Bayesian MPR (RxPolya) models_

NimbusSDK.jl provides fast, probabilistic inference for Brain-Computer Interface applications. Built on **RxInfer.jl**, the SDK delivers sub-20ms inference latency with full uncertainty quantification through **Bayesian LDA (RxLDA)**, **Bayesian GMM (RxGMM)**, and **Bayesian MPR (RxPolya)** implementations.
...
NimbusSDK.jl currently provides three production-ready Bayesian models:
...
<CardGroup cols={3}>
  <Card
    ...
    href="/models/rxlda"
  >
    **Bayesian Linear Discriminant Analysis** with shared covariance. Fast (10-15ms), efficient, ideal for well-separated classes like motor imagery. API name: `RxLDAModel`.
  </Card>
  <Card
    ...
    href="/models/rxgmm"
  >
    **Bayesian Gaussian Mixture Model** with class-specific covariances. More flexible (15-25ms), better for overlapping distributions like P300. API name: `RxGMMModel`.
  </Card>
  <Card
    ...
    href="/models/rxpolya"
  >
    **Bayesian Multinomial Probit Regression** with continuous transitions. Most flexible (15-25ms), ideal for complex multinomial classification tasks. API name: `RxPolyaModel`.
  </Card>
</CardGroup>
...
- **Core**: Julia 1.9+
- **Inference Engine**: [RxInfer.jl](https://rxinfer.com/) - Reactive message passing for Bayesian inference
- **Models**: RxLDA (shared covariance), RxGMM (class-specific covariances), Bayesian MPR (multinomial probit regression)
...
- ✅ Bayesian LDA (RxLDA), Bayesian GMM (RxGMM), and Bayesian MPR (RxPolya) models
