...
- ✅ **Python SDK** (`nimbus-bci`) with sklearn compatibility and MNE integration
- ✅ **Julia SDK** (`NimbusSDK.jl`) with RxInfer.jl reactive message passing
- ✅ Bayesian LDA, Bayesian GMM, and Bayesian Softmax/MPR models
