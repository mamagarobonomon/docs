...
_Production-ready Bayesian BCI inference with RxLDA, RxGMM, and Bayesian MPR models_

NimbusSDK.jl provides fast, probabilistic inference for Brain-Computer Interface applications. Built on **RxInfer.jl**, the SDK delivers sub-20ms inference latency with full uncertainty quantification through **RxLDA** (Linear Discriminant Analysis), **RxGMM** (Gaussian Mixture Model), and **Bayesian MPR** (Multinomial Probit Regression) implementations.
...
- ✅ RxLDA, RxGMM, and Bayesian MPR models
