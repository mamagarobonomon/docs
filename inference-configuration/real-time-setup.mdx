...
<Note>
Both SDKs support Bayesian models: **Bayesian LDA**, **Bayesian GMM**, **Bayesian Softmax**, and **Bayesian STS** (Python SDK only). Choose based on your accuracy, latency, and adaptivity requirements.
</Note>
