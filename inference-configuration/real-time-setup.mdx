...
<Note>
NimbusSDK supports three Bayesian models: **Bayesian LDA (RxLDA)**, **Bayesian GMM (RxGMM)**, and **Bayesian MPR (RxPolya)**. Choose based on your accuracy and latency requirements.
</Note>
