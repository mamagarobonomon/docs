...
description: "Real-time chunk-by-chunk BCI processing with NimbusSDK streaming mode. Learn chunk processing, temporal aggregation, and streaming sessions."
...
<Note>
Both SDKs support Bayesian models: **Bayesian LDA**, **Bayesian GMM**, **Bayesian Softmax/MPR**, and **Bayesian STS** (Python SDK only). All support streaming inference with similar latencies.
