...
<Note>
Both SDKs support Bayesian models: **Bayesian LDA**, **Bayesian GMM**, **Bayesian Softmax**, and **Bayesian STS** (Python SDK only). All support streaming inference with similar latencies.
