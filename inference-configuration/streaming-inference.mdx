...
<Note>
NimbusSDK supports three Bayesian models: **Bayesian LDA (RxLDA)**, **Bayesian GMM (RxGMM)**, and **Bayesian MPR (RxPolya)**. All support streaming inference with similar latencies.
</Note>
