...
description: "Offline analysis and model training with NimbusSDK batch inference. Process multiple trials efficiently for training and evaluation."
...
<Note>
Both SDKs support Bayesian models: **Bayesian LDA**, **Bayesian GMM**, **Bayesian Softmax/MPR**, and **Bayesian STS** (Python SDK only). Examples show both SDKs - you can use any model type.
</Note>
