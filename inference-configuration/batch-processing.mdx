...
<Note>
Both SDKs support three Bayesian models: **Bayesian LDA**, **Bayesian GMM**, and **Bayesian Softmax/MPR**. Examples show both SDKs - you can use any model type.
</Note>
...
# Save model
from nimbus_pysdk import nimbus_save
