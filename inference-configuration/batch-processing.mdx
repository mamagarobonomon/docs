...
<Note>
Both SDKs support Bayesian models: **Bayesian LDA**, **Bayesian GMM**, **Bayesian Softmax**, and **Bayesian STS** (Python SDK only). Examples show both SDKs - you can use any model type.
</Note>
