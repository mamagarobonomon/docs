...
description: "Guidelines for preparing EEG data for Nimbus models"
icon: "list-filter"
---
...
✅ Bayesian inference with Bayesian LDA (RxLDA), Bayesian GMM (RxGMM), and Bayesian MPR (RxPolya) models  
...
<CardGroup cols={2}>
  ...
  <Card title="Code Examples" icon="brackets-curly" href="/examples/basic-examples">
