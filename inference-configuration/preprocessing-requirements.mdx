...
description: "Guidelines for preparing EEG data for Nimbus models. Learn about CSP, bandpower, ERP extraction, and feature preparation for BCI classification."
...
✅ Bayesian inference with Bayesian LDA (RxLDA), Bayesian GMM (RxGMM), Bayesian Softmax (RxPolya), and Bayesian STS (NimbusSTS - Python only) models  
...
<Tip>
See the complete [Feature Normalization](/inference-configuration/feature-normalization) guide for best practices, API reference, and common pitfalls.
</Tip>
