...
description: "Understanding NimbusSDK's probabilistic BCI models"
icon: "brain"
---

# Model Specification

NimbusSDK provides **pre-built probabilistic models** (RxLDA and RxGMM) powered by [RxInfer.jl](https://github.com/ReactiveBayes/RxInfer.jl), a reactive message passing framework for efficient Bayesian inference.

<Note>
**Current Status**: NimbusSDK provides **ready-to-use models** (RxLDA, RxGMM) rather than a custom model specification language. This page documents the conceptual foundations and future directions.
</Note>
...
**Characteristics:**
- **Shared covariance** across all classes (Gaussian assumption)
...
**Characteristics:**
- **Class-specific covariances** (more flexible)
...
Both RxLDA and RxGMM are built on factor graphs with reactive message passing:
