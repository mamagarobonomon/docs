export declare const locales: readonly ["en", "cn", "zh", "zh-Hans", "zh-Hant", "es", "fr", "fr-CA", "ja", "jp", "pt", "pt-BR", "de", "ko", "it", "ru", "ro", "cs", "id", "ar", "tr", "hi"];
...
export declare const LlmSupportedLocaleCodes: ("en" | "cn" | "zh" | "zh-Hans" | "zh-Hant" | "es" | "fr" | "fr-CA" | "ja" | "jp" | "pt" | "pt-BR" | "de" | "ko" | "it" | "ru" | "ro" | "cs" | "id" | "ar" | "tr" | "hi")[];
export declare const LlmSupportedLocaleDisplayNames: ("English" | "Simplified Chinese" | "Traditional Chinese" | "Spanish" | "French" | "Canadian French" | "Japanese" | "Portuguese" | "Brazilian Portuguese" | "German" | "Korean" | "Italian" | "Russian" | "Romanian" | "Czech" | "Indonesian" | "Arabic" | "Turkish" | "Hindi")[];
