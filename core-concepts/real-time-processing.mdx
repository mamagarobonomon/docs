...
description: "How Nimbus achieves sub-25ms latency for responsive brain-computer interfaces. Learn about streaming inference, chunk processing, and low-latency BCI."
...
<Note>
**Model coverage (streaming/batch):** Bayesian LDA (RxLDA), Bayesian GMM (RxGMM), Bayesian Softmax (RxPolya), and Bayesian STS (RxSTS / `NimbusSTS`, Python SDK only).
</Note>
