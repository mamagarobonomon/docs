...
- **Python SDK**: Pre-compiled Bayesian models (LDA, GMM, Softmax, STS) with optimized inference engines. The underlying factor graph architecture runs efficiently without requiring manual graph construction
