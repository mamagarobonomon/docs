...
NimbusLDA and NimbusQDA (both SDKs), plus NimbusSoftmax (Python) / NimbusProbit (Julia), handle temporal structure through proper feature aggregation and trial-level inference.
...
NimbusLDA and NimbusQDA (both SDKs), NimbusSoftmax (Python) / NimbusProbit (Julia), and NimbusSTS (Python) all use factor graph representations:
