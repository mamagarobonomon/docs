...
Both SDKs use Bayesian inference to model uncertainty explicitly with production-ready models: Bayesian LDA, Bayesian GMM, Bayesian Softmax, and Bayesian STS (Python SDK).
