...
NimbusSDK uses Bayesian inference via **RxInfer.jl** to model uncertainty explicitly with three production-ready models: Bayesian LDA (RxLDA), Bayesian GMM (RxGMM), and Bayesian MPR (RxPolya).
