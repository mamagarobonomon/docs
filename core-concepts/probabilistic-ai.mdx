...
Both SDKs use Bayesian inference to model uncertainty explicitly with three production-ready models: Bayesian LDA, Bayesian GMM, and Bayesian Softmax/MPR.
