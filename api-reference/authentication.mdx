...
<Note>
**Python SDK Users:** The Python SDK (`nimbus-pysdk`) does **not require authentication** or API keys. It runs entirely locally on your machine. This authentication guide is for **Julia SDK users only**.
