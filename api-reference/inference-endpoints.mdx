...
curl "https://api.nimbusbci.com/v1/models/list?api_key=nbci_live_...&type=NimbusLDA"
```
...
model = load_model(NimbusLDA, "motor_imagery_4class_v1")  # ~2-3 seconds

# Subsequent calls: loads from cache
model = load_model(NimbusLDA, "motor_imagery_4class_v1")  # &lt;100ms
```
