---
title: "Streaming API"
description: "Real-time streaming inference API for Nimbus. WebSocket and HTTP streaming endpoints for real-time BCI inference."
...
<Note>
**Model coverage:**
- **Julia SDK** streaming supports: `RxLDAModel`, `RxGMMModel`, `RxPolyaModel` (Bayesian Softmax)
