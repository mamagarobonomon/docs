...
Bayesian LDA extends traditional Linear Discriminant Analysis with full Bayesian inference, providing:<br/>
...
## Comparison: Bayesian LDA vs Bayesian QDA vs Bayesian Softmax vs Bayesian STS

| Aspect | Bayesian LDA (NimbusLDA) | Bayesian QDA (NimbusQDA) | Bayesian Softmax (NimbusSoftmax) | Bayesian STS (NimbusSTS) |
|--------|-------|-------|-------|-------|
...
- **Data is stationary** (distributions don't change over time):
  ...
  - Overlapping classes → **Bayesian QDA** ✓ More flexible
...
<CardGroup cols={2}>
  ...
  <Card title="Bayesian Softmax (NimbusSoftmax)" icon="brain" href="/models/rxpolya">
