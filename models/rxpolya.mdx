...
description: "Bayesian Multinomial Probit Regression with uncertainty quantification using RxInfer.jl. Flexible 15-25ms inference for complex multinomial BCI classification tasks."
keywords: ["Bayesian MPR", "RxPolya", "Multinomial Probit Regression", "Bayesian Softmax", "multinomial classification", "BCI", "logistic regression", "RxInfer", "NimbusSoftmax", "probabilistic classification"]
icon: "brain"
---
...
## Comparison: Bayesian MPR vs RxLDA vs RxGMM vs RxSTS

| Aspect | Bayesian MPR | RxLDA | RxGMM | RxSTS |
|--------|---------|-------|-------|-------|
| **Mathematical Model** | Bayesian Multinomial Probit Regression | Pooled Gaussian Classifier (PGC) | Heteroscedastic Gaussian Classifier (HGC) | State-Space Model (EKF) |
...
<script type="application/ld+json">
{
  ...
  "keywords": "Bayesian MPR, RxPolya, Multinomial Probit Regression, Bayesian Softmax, multinomial classification, BCI, logistic regression, RxInfer, NimbusSoftmax",
  "inLanguage": "en-US",
