...
<Warning>
**Coming Soon**: This multi-modal approach is not yet implemented in NimbusSDK.jl.
...
These models currently process single-modality feature inputs (e.g., EEG-derived features). Multi-modal sensor fusion is planned for future releases.
</Warning>
