...
keywords: ["Bayesian STS", "RxSTS", "Structural Time Series", "Kalman Filter", "non-stationary BCI", "adaptive classification", "temporal drift", "state-space model", "BCI", "EEG"]
icon: "brain"
---
...
**Use [Bayesian LDA](/models/rxlda) or [Bayesian GMM](/models/rxgmm) instead if:**
...
<script
  ...
  dangerouslySetInnerHTML={{
    __html: JSON.stringify({
      ...
      keywords:
        'Bayesian STS, RxSTS, Structural Time Series, Kalman Filter, non-stationary BCI, adaptive classification, temporal drift, state-space model, BCI, EEG',
      inLanguage: 'en-US',
