---
title: "Bayesian QDA"
description: "NimbusQDA is a Bayesian QDA-style classifier with class-specific covariances. Flexible 15-25ms inference for P300 and overlapping class distributions."
...
Bayesian QDA extends beyond traditional Gaussian classifiers by allowing each class to have its own covariance structure:<br/>
...
model = load_model(NimbusQDA, "p300_gmm_v1")
...
## Comparison: Bayesian QDA vs Bayesian LDA vs Bayesian Softmax vs Bayesian STS

| Aspect | Bayesian QDA (NimbusQDA) | Bayesian LDA (NimbusLDA) | NimbusProbit | Bayesian STS (NimbusSTS) |
|--------|-------|-------|-------|-------|
...
└─ No → Is speed critical (&lt;15ms)?
    ...
    └─ No → Do classes have different spreads / covariances?
        ├─ Yes → Use Bayesian QDA (more accurate)
...
if rxlda_acc < 0.75
    ...
    println("Bayesian QDA accuracy: $(round(rxgmm_acc*100, digits=1))%")
...
<CardGroup cols={2}>
  ...
  <Card title="NimbusProbit" icon="brain" href="/models/rxpolya">
