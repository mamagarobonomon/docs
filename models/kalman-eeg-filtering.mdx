...
NimbusSDK currently focuses on classification tasks. Kalman filtering for EEG preprocessing is planned for future releases.
</Warning>
...
<CardGroup cols={2}>
  <Card title="SNR Improvement" icon="line-chart">
    Kalman filters can improve Signal-to-Noise Ratio (SNR) by over 5dB in typical EEG recordings, making subsequent classification more robust.
  </Card>
