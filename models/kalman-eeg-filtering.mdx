...
Kalman filtering is a fundamental technique for real-time EEG signal processing, providing optimal state estimation in the presence of noise and artifacts. This model is essential for preprocessing neural signals before classification or control applications.
...
<CardGroup cols={2}>
  <Card title="HMM Brain States" icon="brain" href="/models/hmm-brain-states">
    Learn about discrete brain state modeling
  </Card>
  <Card title="Motor Rhythms" icon="wave-square" href="/models/ar-motor-rhythms">
    Explore autoregressive rhythm analysis
  </Card>
  <Card title="Implementation Guide" icon="code" href="/examples/code-samples">
