...
description: "Real-world BCI applications powered by NimbusLDA and NimbusQDA (Python + Julia), plus NimbusSoftmax (Python) / NimbusProbit (Julia). Assistive technology, neurofeedback, and research applications."
...
<Card title="Research Applications" icon="flask-conical">
  ...
  **Models**: NimbusLDA, NimbusQDA, and NimbusSoftmax (Python) / NimbusProbit (Julia) with custom training  
