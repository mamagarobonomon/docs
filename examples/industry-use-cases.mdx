...
description: "Real-world BCI applications powered by Bayesian LDA (RxLDA), Bayesian GMM (RxGMM), and Bayesian Softmax (RxPolya) models. Assistive technology, neurofeedback, and research applications."
...
<Card title="Research Applications" icon="flask-conical">
  ...
  **Models**: Bayesian LDA (RxLDA), Bayesian GMM (RxGMM), Bayesian Softmax (RxPolya) with custom training  
...
These industry applications demonstrate the real-world potential of Nimbus BCI's probabilistic models across healthcare, assistive technology, and research domains. Both Python and Julia SDKs provide production-ready Bayesian classifiers (Bayesian LDA, Bayesian GMM, Bayesian Softmax, and Bayesian STS for Python) for motor imagery, P300, and SSVEP paradigms.
