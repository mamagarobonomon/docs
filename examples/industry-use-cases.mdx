...
description: "Real-world BCI applications powered by NimbusLDA and NimbusQDA (Python + Julia), plus Bayesian Multinomial (NimbusSoftmax in Python / NimbusProbit in Julia). Assistive technology, neurofeedback, and research applications."
