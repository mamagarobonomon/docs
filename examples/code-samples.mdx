...
Complete example for 4-class Motor Imagery classification using RxLDA.
...
NimbusSDK.authenticate("nbci_live_your_api_key_here")
...
Example of training an RxLDA model on your own labeled data.
