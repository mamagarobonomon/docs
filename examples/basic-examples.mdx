...
- **Julia SDK**: RxInfer.jl-based with pre-trained models → [Julia Quickstart](/quickstart)

For detailed model information, see [Bayesian LDA](/models/rxlda), [Bayesian GMM](/models/rxgmm), [Bayesian Softmax](/models/rxpolya), and [Bayesian STS](/models/rxsts).
</Note>
