---
title: 'Development'
description: 'Development workflow for building BCI applications with Nimbus (Python & Julia). Best practices, debugging, and production deployment.'
...
Model coverage:
- **Both SDKs**: Bayesian LDA (RxLDA), Bayesian GMM (RxGMM), Bayesian Softmax (RxPolya)
- **Python SDK only**: Bayesian STS (RxSTS / `NimbusSTS`)
</Note>
