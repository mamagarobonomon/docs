...
description: "Overview of probabilistic models in Nimbus. Learn about Bayesian LDA, GMM, Softmax, and STS models with factor graphs and reactive message passing."
...
<Info>
**Four Production Models Available:**
...
- [Bayesian STS (RxSTS)](/models/rxsts) - Adaptive, for non-stationary data
...
The static models (LDA, GMM, Softmax) are built on **factor graphs** with **reactive message passing**:
...
<CardGroup cols={2}>
  ...
  <Card title="Bayesian STS (RxSTS)" icon="brain" href="/models/rxsts">
...
<Note>
**Development Philosophy**: NimbusSDK provides **battle-tested, production-ready models** (Bayesian LDA, Bayesian GMM, Bayesian Softmax, Bayesian STS) that are proven effective for BCI applications. These models cover the majority of BCI use cases with fast inference, uncertainty quantification, and online learning. **Bayesian STS** adds adaptive capabilities for non-stationary data and long-duration sessions.
</Note>
...
<script
  ...
  dangerouslySetInnerHTML={{
    __html: JSON.stringify({
      ...
      description:
        'Overview of probabilistic models in Nimbus. Learn about Bayesian LDA, GMM, Softmax, and STS models with factor graphs and reactive message passing.',
      author: {
        '@type': 'Organization',
        name: 'Nimbus BCI',
