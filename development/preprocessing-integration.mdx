...
<Note>
**Python SDK Users:** The `nimbus-pysdk` has native MNE-Python integration! See the [MNE Integration](/python-sdk/mne-integration) guide for streamlined workflows.
...
# 3. Extract CSP features using nimbus-pysdk
