---
title: "API Reference"
description: "Complete API documentation for nimbus-bci Python SDK. Reference for NimbusLDA, NimbusGMM, NimbusSoftmax, NimbusSTS classes and methods."
keywords: ["API reference", "Python SDK", "nimbus-bci", "NimbusLDA", "NimbusGMM", "NimbusSoftmax", "NimbusSTS", "BCI API", "Python documentation"]
icon: "book"
---
