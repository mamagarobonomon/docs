...
description: "Build your first BCI classifier with nimbus-bci in 5 minutes. Learn installation, basic usage, sklearn integration, and real-time streaming inference for Bayesian BCI models."
keywords: ["Python SDK", "nimbus-bci", "BCI quickstart", "Bayesian BCI", "Python tutorial", "sklearn integration", "streaming inference", "motor imagery", "P300"]
icon: "rocket"
---
...
# Compare performance
for name, clf in [("LDA", clf_lda), ("GMM", clf_gmm), 
...
| **NimbusGMM** | P300, overlapping distributions | Fast (15-25ms) | Stateless |
