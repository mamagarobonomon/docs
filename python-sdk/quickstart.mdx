...
```python
import nimbus_pysdk
print(f"nimbus-bci version: {nimbus_pysdk.__version__}")
```
  </Step>
...
| Model | Best For | Speed | Flexibility |
|-------|----------|-------|-------------|
| **NimbusLDA** | Motor imagery, well-separated classes | Fastest (10-15ms) | Lower |
| **NimbusGMM** | P300, overlapping distributions | Fast (15-25ms) | Higher |
| **NimbusSoftmax** | Complex multinomial tasks | Fast (15-25ms) | Highest |
