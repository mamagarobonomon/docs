...
description: "Get started with Nimbus BCI in minutes - from API key to your first BCI application. Learn installation, authentication, and basic inference with NimbusSDK.jl."
...
<CardGroup cols={2}>
  ...
  <Card title="Bayesian Softmax (RxPolya)" icon="brain" href="/models/rxpolya">
    Learn about the Bayesian Softmax (Multinomial Logistic Regression) model
  </Card>
