...
# Optional: Tune hyperparameters for optimal performance (v0.2.0+)
# model = train_model(
#     RxLDAModel,
#     train_data;
#     iterations = 50,
...
#     dof_offset = 2,                    # Regularization strength (default: 2)
#     mean_prior_precision = 0.01        # Prior strength (default: 0.01)
# )
...
<CardGroup cols={2}>
  ...
  <Card title="RxPolya" icon="brain" href="/models/rxpolya">
    Learn about the Bayesian Multinomial Probit Regression model
  </Card>
...
<CardGroup cols={2}>
  <Card title="Motor Imagery BCI" icon="gamepad-2" href="/examples/basic-examples">
  ...
  <Card title="Neurofeedback" icon="brain-circuit" href="/examples/advanced-applications">
